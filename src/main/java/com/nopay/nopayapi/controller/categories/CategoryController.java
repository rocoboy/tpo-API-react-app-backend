package com.nopay.nopayapi.controller.categories;
...
import com.nopay.nopayapi.service.categories.CategoryService;;
...
public class CategoryController {
    ...
    public ResponseEntity<Category> updateCategory(@PathVariable Long id, @RequestBody Category categoryDetails) {
        ...
        if (category.isPresent()) {
            ...
            updatedCategory.setId_parent(categoryDetails.getId_parent());
